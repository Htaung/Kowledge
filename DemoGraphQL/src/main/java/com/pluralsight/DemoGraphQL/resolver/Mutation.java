...
import com.pluralsight.DemoGraphQL.exception.BookNotFoundException;
...
public class Mutation implements GraphQLMutationResolver {
	...
	public Book updateBookPageCount(Integer pageCount, Long id) {
		...
		if(book == null) throw new BookNotFoundException("The book to be updated was not found", id);
